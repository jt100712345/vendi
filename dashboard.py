...
st.markdown("""
    <div style="background: linear-gradient(135deg, rgba(0, 255, 136, 0.1) 0%, rgba(136, 136, 255, 0.1) 100%);
                border-radius: 16px;
                padding: 30px;
                margin-bottom: 30px;
                border: 1px solid rgba(0, 255, 255, 0.2);">
        <h1 style="color: white; margin-bottom: 10px;">📈 Kalshi BTC 15-Minute Trader</h1>
        <h3 style="color: #8888ff; margin-top: 0;">Visual Command Center - Real-time Trading Intelligence</h3>
""", unsafe_allow_html=True)
...
with col1:
    st.markdown("""
        <div style="background: rgba(255, 255, 255, 0.03);
                    ...
                    border: 1px solid rgba(255, 255, 255, 0.05);
                    height: 100%;">
            <h2 style="color: white; margin-bottom: 20px;">🎯 Probability Gauge</h2>
    """, unsafe_allow_html=True)
...
with col2:
    st.markdown("""
        <div style="background: rgba(255, 255, 255, 0.03);
                    ...
                    border: 1px solid rgba(255, 255, 255, 0.05);
                    height: 100%;">
            <h2 style="color: white; margin-bottom: 20px;">📊 Performance Metrics</h2>
    """, unsafe_allow_html=True)
...
with col3:
    st.markdown("""
        <div style="background: rgba(255, 255, 255, 0.03);
                    ...
                    border: 1px solid rgba(255, 255, 255, 0.05);
                    height: 100%;">
            <h2 style="color: white; margin-bottom: 20px;">📚 Live Order Book</h2>
    """, unsafe_allow_html=True)
...
st.markdown("""
    <div style="background: rgba(255, 255, 255, 0.03);
                ...
                border: 1px solid rgba(255, 255, 255, 0.05);
                margin-top: 30px;">
        <h2 style="color: white; margin-bottom: 20px;">⏱️ Settlement Watch</h2>
""", unsafe_allow_html=True)
...
st.markdown("""
    <div style="background: rgba(255, 255, 255, 0.03);
                ...
                border: 1px solid rgba(255, 255, 255, 0.05);
                margin-top: 30px;">
        <h2 style="color: white; margin-bottom: 20px;">📜 Recent Trades</h2>
""", unsafe_allow_html=True)
...
st.markdown("""
    <div style="background: rgba(255, 255, 255, 0.03);
                ...
                border: 1px solid rgba(255, 255, 255, 0.05);
                margin-top: 30px;">
        <h2 style="color: white; margin-bottom: 20px;">🔧 System Health</h2>
""", unsafe_allow_html=True)
...
st.markdown("""
    <div style="background: rgba(255, 255, 255, 0.03);
                ...
                border: 1px solid rgba(255, 255, 255, 0.05);
                margin-top: 30px;">
        <h2 style="color: white; margin-bottom: 20px;">📈 Performance Monitoring</h2>
""", unsafe_allow_html=True)
